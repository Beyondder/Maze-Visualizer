...
public class MazeCanvas extends Canvas {
    ...
    // ── Palette ────────────────────────────────────────────────────────
private static final Color C_BACKGROUND   = Color.web("black");  // deep teal-black
...
private static final Color C_CURRENT      = Color.web("red");  // amber (focus)
private static final Color C_FRONTIER     = Color.web("white"); // bright cyan
private static final Color C_OPEN_SET     = Color.web("blue"); // sky blue
private static final Color C_CLOSED_SET   = Color.web("black"); // deep teal
